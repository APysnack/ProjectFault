...
var timeout = 300;
var lastIndex = 0;
const audio_path = '/static/audio/audio-files/'
const image_path = '/static/audio/audio-images/'
...
function loadSong(index){
    ...
    audioImage.src = site_root + image_path + audioDictionary[index].image_file
	songTitle.innerText = audioDictionary[index].title
    songPath = site_root + audio_path + audioDictionary[index].url
